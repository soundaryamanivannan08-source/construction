...
for (const file of files) {
    ...
    content = content.replace(
        ...
        '<div class="flex items-center gap-2 text-2xl font-bold"><img src="assest/logo.1.jpeg" alt="Stackly Logo" class="h-10 w-auto object-contain"></div>'
    );
    ...
    content = content.replace(
        ...
        '<div class="flex items-center gap-2 text-2xl font-bold text-white mb-6"><img src="assest/logo.1.jpeg" alt="Stackly Logo" class="h-10 w-auto object-contain rounded"></div>'
    );
    ...
    content = content.replace(
        ...
        '<div class="brand-logo"><img src="assest/logo.1.jpeg" alt="Stackly Logo" style="height: 40px; width: auto; border-radius: 4px;"></div>'
    );
    ...
    content = content.replace(
        ...
        '<div class="mobile-logo"><img src="assest/logo.1.jpeg" alt="Stackly Logo" style="height: 32px; width: auto; border-radius: 4px;"></div>'
    );
