...
files.forEach(f => {
    ...
    // Fix footer logo
    const oldLogo = '<div class="flex items-center gap-2 text-2xl font-bold text-white mb-6"><img src="assest/logo.1.png" alt="Stackly Logo" class="h-10 w-auto object-contain rounded"></div>';
    const newLogo = '<div class="flex items-center gap-2 text-2xl font-bold text-white mb-6"><a href="index.html"><img src="assest/logo.1.png" alt="Stackly Logo" class="h-10 w-auto object-contain rounded"></a></div>';
